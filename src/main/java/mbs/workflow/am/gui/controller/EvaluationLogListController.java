...
import mbs.workflow.am.gui.service.EvaluationLogListService;
...
public class EvaluationLogListController implements Workflow {

    @EJB
    private EvaluationLogListService service;
